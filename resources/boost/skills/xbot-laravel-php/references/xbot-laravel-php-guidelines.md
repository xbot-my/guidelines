# Laravel & PHP Guidelines (Reference)
...
**Follow Laravel conventions first.** If Laravel has a documented way to do something, use it. Only deviate when you
...
- Mailable: purpose + `Mail` suffix (`AccountActivatedMail`)
...
Source: https://github.com/xbot-my/guidelines/resources/boost/skills/xbot-laravel-php/references/laravel-php-guidelines.md
